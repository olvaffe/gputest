...
static void
tri_test_draw_pre(struct tri_test *test, VkCommandBuffer cmd)
{
    struct vk *vk = &test->vk;
...
static void
tri_test_draw_post(struct tri_test *test, VkCommandBuffer cmd)
{
    struct vk *vk = &test->vk;
...
tri_test_draw(struct tri_test *test)
{
    ...
    tri_test_draw_pre(test, cmd);
    tri_test_draw_triangle(test, cmd);
    tri_test_draw_post(test, cmd);
