...
static void
gs_test_draw_pre(struct gs_test *test, VkCommandBuffer cmd)
{
    struct vk *vk = &test->vk;
...
static void
gs_test_draw_post(struct gs_test *test, VkCommandBuffer cmd)
{
    struct vk *vk = &test->vk;
...
gs_test_draw(struct gs_test *test)
{
    ...
    gs_test_draw_pre(test, cmd);
    gs_test_draw_points(test, cmd);
    gs_test_draw_post(test, cmd);
